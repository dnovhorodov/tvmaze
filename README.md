...
You could also specify the range of ids for scraping and execution mode. Parallel execution is fast, does not work well with LiteDB. To get more predictable results use sequential execution mode: `Exec = Sequential`
